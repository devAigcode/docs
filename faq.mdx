...
description: "Find answers to the questions builders ask most often about AutoCoder.cc — pricing and credits, how the AI dev platform works, deploying and hosting projects, billing, and what the platform can do today."
...
- **Standard (\$40/month)**: Designed for creators and personal brands. Includes 45 credits (approx. 3–5 complete projects), **Source Code Export**, unlimited temporary subdomains, and email support.
