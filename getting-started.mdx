...
description: "A quick start for AutoCoder.cc — the basic steps for creating your first application from a natural-language prompt, signing in, generating the project structure, and previewing the live demo before you deploy."
icon: "rocket"
