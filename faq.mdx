...
- **Free**: Ideal for exploring AutoCoder and building lightweight prototypes. Includes static single-page (view-only) demos, backend project support, 1GB disk space, and unlimited private projects. No project download, custom domains, or dedicated support.
- **Starter**: Only for new users getting started with production-ready builds. Includes a monthly plan credit allocation, 1 custom domain binding, 1GB disk space, unlimited private projects and unlimited edits, full multi-page projects with data/admin backend, login and payment Access API integrations, dedicated customer service support, instant multi-role switching, and project downloads.
- **Standard**: Designed for creators and personal brands building complete, production-ready applications. Includes an expanded monthly plan credit allocation, 1 custom domain binding, 10GB boosted disk space, unlimited private projects and unlimited edits, full multi-page projects with data/admin backend, login and payment Access API integrations, dedicated customer service support, instant multi-role switching, and project downloads.
- **Pro**: Built for power users and startup teams for advanced full-stack development. Includes a high-volume monthly plan credit allocation, unlimited custom domain binding, multiple primary domain settings, unlimited multi-page full-stack projects, unlimited subdomains, access to premium features, domain purchasing capability, priority email support, project downloads, and exclusive credit top-up offers.
...
<AccordionGroup>
  <Accordion title="What is the limited-time offer for new users?">
    New users can enjoy a limited-time **20% discount** on the Starter, Standard, and Pro plans within **48 hours of registration**.

    The Starter plan is exclusively available to new users. After the first month, it will **automatically renew and upgrade** to the Standard plan.
  </Accordion>
  ...
  <Accordion title="Do you support refunds? What should I do if the generation fails?">
    ...
    2. **Credit compensation**: If project generation fails entirely due to system bugs or platform errors, monetary refunds will not be issued. However, you may contact [support@autocoder.cc](mailto:support@autocoder.cc) with error screenshots and usage details. After verification, we will fully refund the credits consumed due to the error.
  </Accordion>

  <Accordion title="Will my subscription be automatically renewed?">
    Yes. Paid subscriptions automatically renew at the end of each billing cycle. Monthly plans renew every month, while annual plans renew every year, unless you cancel before the next renewal date. The **\$19.9** Starter price is a first-month offer for new users only. After the first month, your subscription will automatically switch to the Standard plan at **\$39.2/month**.

    Canceling your subscription only stops future renewals and does not automatically result in a refund. You may request a full refund within **7 days** of purchase only if you have not used any generation services or credits. Refunds are generally unavailable once generation services or credits have been used. To submit a refund request, please email [support@autocoder.cc](mailto:support@autocoder.cc).
  </Accordion>

  <Accordion title="Can I cancel my subscription?">
    Yes. You may cancel your paid subscription at any time via the subscription or billing settings in your account.

    After unsubscribing, your subscription benefits will remain valid for the duration of the current paid billing cycle. Once the cancellation takes effect, your subscription will no longer renew automatically.

    Canceling your subscription will not automatically refund the payments already made for the current billing cycle.

    **How to cancel your subscription:**

    Go to the [pricing page](https://www.autocoder.cc/en/dashboard/pricing) and click **Manage → Cancel Subscription**, then confirm. Your subscription will no longer renew automatically after the current billing period ends. To resume your subscription, click **Renew Subscription**. You can download your invoices from **Billing History**.
  </Accordion>

  <Accordion title="Can I purchase additional credits?">
    Yes. If the credits included in your current plan are insufficient, you may purchase an additional credit package separately without upgrading or switching your existing subscription plan.

    The Starter plan is a first-month promotional offer for new users and does not currently allow additional credit purchases.

    There are 5 tiers of credit packages available:

    - **\$10: 15 Credits**
    - **\$20: 30 Credits**
    - **\$40: 65 Credits**, including an 8% bonus
    - **\$80: 135 Credits**, including a 12% bonus
    - **\$120: 210 Credits**, including a 16% bonus

    Credit packages are purchased on a one-time basis and will not auto-renew. Your original subscription plan will continue to auto-renew on a monthly or annual cycle as applicable.

    You can also get free credits through **Invite & Earn** on the homepage.
  </Accordion>
</AccordionGroup>
...
- **Dedicated entry**: open the generator from the AutoCoder homepage.
...
<AccordionGroup>
  <Accordion title="Where can I find the Google Maps Website Generator?">
    After logging in, click **Paste a Google Maps link to create a full-stack website** above the input box on the homepage to access the Google Maps Website Generator. You can also open the generator directly from the link above.

    <Frame caption="Google Maps Generator entry in the AutoCoder homepage.">
      ![AutoCoder homepage with the Paste a Google Maps link to create a full-stack website button highlighted above the prompt input box](/images/faq/google-maps-01-homepage-entry.png)
    </Frame>
  </Accordion>
  ...
  <Accordion title="How do I copy the correct business link from Google Maps?">
    ...
    <Frame>
      ![Copying the Share link from a Google Maps business listing](/images/faq/google-maps-03-share-link.gif)
    </Frame>
  </Accordion>
