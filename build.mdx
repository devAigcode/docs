---
title: "Build Apps from Natural Language with AutoCoder.cc"
description: "Build is AutoCoder.cc's core module — turn ideas into working applications through Progressive Build. Walk through Draft, Requirements, and Full Project, using text, images, files, or voice, without writing code."
icon: "hammer"
canonical: "https://www.autocoder.cc/docs/build"
sidebarTitle: "Build"
---

**Build** is the core capability module of AutoCoder.cc. Describe what you want using natural language, images, files, wireframes, flowcharts, or voice, and AutoCoder.cc generates a working application through Progressive Build.
...
Requirement input is the first step in building an application with AutoCoder.cc. Describe the product you want to create using natural language, or attach images, files, wireframes, flowcharts, or voice. The system understands these multimodal inputs and starts Progressive Build with an editable Draft.
...
After you review the Draft, AutoCoder.cc organizes your inputs into a structured **Requirement List**. This helps you confirm pages, user flows, features, and logic before generating the Full Project, and lets you keep optimizing product requirements.
...
In the project preview, switch between different views to inspect the application's structure and layout across platforms, including **Web View**, **App View**, and **Backend View**.
...
After generating the Draft or Full Project, AutoCoder.cc provides two ways for you to continue refining the application.

### Chat modification

Describe the content you want to adjust using multimodal AI chat — text, images, files, or voice. AutoCoder.cc will update the page structure or component content so you can iterate without regenerating the entire project.
...
**Visual Editing** allows you to make visual modifications directly in the generated preview. Click the **Edit** button to enter edit mode, then click a page component to open the corresponding editing panel.
